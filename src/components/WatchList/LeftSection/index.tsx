...
const LeftSection = () => {
    ...
    const gradientBg = 'bg-[linear-gradient(90deg,#111313_-17.67%,#222622_44.55%,#111313_125.21%)]';
            ...
            <div className='flex flex-row gap-[2rem] items-center'>
                <div className="w-[46rem] flex items-center gap-[1.2rem] px-[0.8rem] py-[0.8rem] bg-[var(--bg-primary)] rounded-[1.2rem]">
                        ...
                        {menuOptions.map((option) => (
                            <SelectItem
                                ...
                                classNames={{
                                    ...
                                    title: "text-[1.5rem] font-[600] leading-[1.4] text-[var(--text-primary)]",
                                }}
                            >
                                {option.label}
                            </SelectItem>
                    ...
                    <button
                        ...
                        className={`flex items-center cursor-pointer h-[3.6rem] px-[1.2rem] py-[1rem] rounded-[1.2rem] text-[1.5rem] font-[500] leading-[1.4] whitespace-nowrap text-center ${activeTab === 'buy-signal'
                    ...
                    <button
                        ...
                        className={`flex items-center cursor-pointer h-[3.6rem] px-[1.2rem] py-[1rem] rounded-[1.2rem] text-[1.5rem] font-[500] leading-[1.4] whitespace-nowrap text-center ${activeTab === 'sell-signal'
                            ? `${gradientBg} text-[var(--text-primary)]`
                            : 'text-[var(--text-quaternary)]'
                            }`}
                    >
                ...
                </div>
                {
                    ...
                    <SearchSymbol onStockSelect={(stock) => console.log('Selected stock:', stock)} />
                }
            </div>
